...
export default async function Home() {
  ...
  // On prend 5 brèves (ou plus selon besoin)
      ...
      <div className="container mx-auto px-4 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
            ...
            <div className="lg:col-span-8 border-r border-gray-200 pr-4 flex flex-col">
                <div className="bg-red-600 text-white inline-block px-3 py-1 text-sm font-bold uppercase mb-2 self-start">Actualité - Politique</div>
                {politique && (
                    <div className="flex flex-col md:flex-row gap-4 items-start flex-1">
                        {/* IMAGE */}
                        <div className="w-full md:w-5/12 flex-shrink-0">
                            <img src={politique.image_url} className="w-full h-auto object-cover border border-gray-200 shadow-sm" />
                        </div>
                        ...
                        <div className="flex-1 flex flex-col h-full">
                            ...
                            <div className="text-base text-gray-800 text-justify leading-snug flex-grow">
            ...
            {/* SIDEBAR (4 cols) - Flex column pour remplir la hauteur */}
            <div className="lg:col-span-4 flex flex-col gap-4 h-full justify-between">
                
                {/* L'info en continue */}
                <div className="bg-gray-50 p-3 border border-gray-200 shadow-sm rounded-sm">
                    <div className="bg-red-700 text-white text-center text-sm font-bold uppercase py-1 mb-2">L'info en continue</div>
                ...
                {/* --- PUBLICITÉ DE REMPLISSAGE (FILL SPACE) --- */}
                {/* Ce bloc prend tout l'espace restant (flex-grow) pour s'aligner avec la colonne de gauche */}
                <div className="flex-grow bg-gray-100 border border-gray-200 flex flex-col items-center justify-center min-h-[100px] text-center p-2">
                    <span className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-1">Publicité</span>
                    <div className="w-full h-full bg-white border border-dashed border-gray-300 flex items-center justify-center">
                        <span className="text-gray-300 text-xs font-bold uppercase">Votre annonce ici</span>
                    </div>
                </div>
        ...
        {/* ... (Reste du code identique : Section 2, 3, 4) ... */}
